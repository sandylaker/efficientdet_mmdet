...
from models.backbones.mmdet_utils import SE
from models.backbones.activations import MemoryEfficientSwish as Swish
...
class MBConv(nn.Module):
    ...
    def __init__(self,
        ...
        if exp_width != input_width:
            self.exp = build_conv_layer(conv_cfg, input_width, exp_width, 1, stride=1, padding=0,
                                        bias=False)
        ...
        self.dwise = build_conv_layer(conv_cfg, exp_width, exp_width, kernel, stride=stride,
                                      **dwise_args)
        ...
        self.lin_proj = build_conv_layer(conv_cfg, exp_width, output_width, 1, stride=1, padding=0,
                                         bias=False)
        self.lin_proj_bn_name, lin_proj_bn = build_norm_layer(norm_cfg, output_width,
                                                              postfix='lin_proj')
